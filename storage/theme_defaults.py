...
THEME_COLOR_DOCS: dict[str, str] = {
    ...
    'file_table_inactive_selected_background': 'Selected rows in an unfocused file table',
...
DEFAULT_THEMES: dict[str, ThemeColorDict] = {
    'solarized': {
        ...
        'file_table_inactive_selected_background': "#ebe3ca",
    ...
    'light': {
        ...
        'file_table_inactive_selected_background': '#d0e4f7',
    ...
    'dark': {
        ...
        'file_table_inactive_selected_background': '#31556b',
